...
const NoChatSeletedPage = () => {
  ...
  return (
    <div className='flex items-center flex-col w-full h-full justify-center'>
      <div className='hometext text-center px-4 sm:text-lg md:text-xl lg:text-2xl font-semibold text-opacity-70'>
        <p className="animate-fade-in">Hey there, 
          <span className="text-blue-600"> {authUser.nickname}</span>! 
          <span> 👋 </span>
        </p>
      <p className="homesecondtext">Say hello to your next great chat! <span className="text-blue-300">✨</span></p>
      </div>
      <div className='hometext text-opacity-70 mt-5'>
